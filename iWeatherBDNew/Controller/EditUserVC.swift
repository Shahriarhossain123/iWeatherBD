...
class EditUserVC: UIViewController {
    ...
    @IBOutlet weak var UpdateUI: UIButton!
    ...
    func editUIView() {
        ...
        UpdateUI.layer.cornerRadius = 8
        UpdateUI.layer.shadowColor = UIColor(red: 255/255, green: 150/255, blue: 15/255, alpha: 1.0).cgColor
        UpdateUI.layer.shadowOpacity = 1
        UpdateUI.layer.shadowOffset = .zero
        UpdateUI.layer.shadowRadius = 3
